---
name: ui-ux-pro-max
description: AI-powered design intelligence toolkit. Use when building UI components, landing pages, dashboards, or any frontend work needing design guidance on styles, colors, typography, charts, or UX best practices. Provides searchable databases via Python scripts for product types, UI styles (glassmorphism, brutalism, minimalism), font pairings, color palettes, chart recommendations, and UX guidelines. Triggers: any frontend/UI task, 'what style fits', 'recommend colors', 'choose fonts', 'design system'.
---

# UI/UX Pro Max Skill

AI-powered design intelligence: searchable databases of UI styles, color palettes, font pairings, chart types, and UX guidelines.
## When to Apply
